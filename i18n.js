...
const translations = {
  en: {
    ...
    'arch.harness.title': 'AI Harness Engineer / Agent Systems Engineer',
    'arch.harness.desc': 'Design and implementation of harness engineering systems to make AI model-based agent usage reliable and production-grade.',
    'arch.harness.point1.title': 'Agent Architecture',
    'arch.harness.point1.desc': 'Defining agent architectures following the paradigm Agent = Model + Harness.',
    'arch.harness.point2.title': 'Systemic Constraints',
    'arch.harness.point2.desc': 'Implementing systemic constraints: static validation (type checking), linters, and runtime guardrails.',
    'arch.harness.point3.title': 'Feedback Loops',
    'arch.harness.point3.desc': 'Designing feedback loops to automatically correct errors and limit output drift.',
    'arch.harness.point4.title': 'Context Engineering',
    'arch.harness.point4.desc': 'Structuring context engineering: specification files, enriched documentation, and long-context management.',
    'arch.harness.point5.title': 'Multi-Step Agent Orchestration',
    'arch.harness.point5.desc': 'Orchestrating multi-step agents with dependency and state control.',
    'arch.harness.point6.title': 'Sandboxing',
    'arch.harness.point6.desc': 'Implementing secure environments (sandboxing) for autonomous code execution.',
    'arch.harness.point7.title': 'Tool Governance',
    'arch.harness.point7.desc': 'Tool and resource access governance (filesystem, APIs) with integrated security policies.',
    'arch.harness.results.label': 'Results',
    'arch.harness.results.1': 'Significant improvement in autonomous task success rate.',
    'arch.harness.results.2': 'Reduction of non-deterministic errors and unpredictable behaviors.',
    'arch.harness.results.3': 'Increased agent capacity to produce complex code reliably and reproducibly.',
  ...
  fr: {
    ...
    'arch.harness.label': 'Harness Engineering',
    'arch.harness.title': 'AI Harness Engineer / Agent Systems Engineer',
    'arch.harness.desc': "Conception et mise en œuvre de systèmes de harness engineering pour fiabiliser et industrialiser l'usage d'agents basés sur des modèles d'IA.",
    'arch.harness.point1.title': "Architecture d'agents",
    'arch.harness.point1.desc': "Définition d'architectures d'agents selon le paradigme Agent = Modèle + Harnais.",
    'arch.harness.point2.title': 'Contraintes systémiques',
    'arch.harness.point2.desc': "Mise en place de contraintes systémiques : validation statique (type checking), linters, garde-fous d'exécution.",
    'arch.harness.point3.title': 'Boucles de rétroaction',
    'arch.harness.point3.desc': "Conception de boucles de rétroaction (feedback loops) pour corriger automatiquement les erreurs et limiter la dérive des outputs.",
    'arch.harness.point4.title': 'Ingénierie de contexte',
    'arch.harness.point4.desc': "Structuration de l'ingénierie de contexte : fichiers de spécifications, documentation enrichie, gestion du contexte long.",
    'arch.harness.point5.title': 'Orchestration multi-agents',
    'arch.harness.point5.desc': "Orchestration d'agents multi-étapes avec contrôle des dépendances et des états.",
    'arch.harness.point6.title': 'Sandboxing',
    'arch.harness.point6.desc': "Implémentation d'environnements sécurisés (sandboxing) pour l'exécution autonome de code.",
    'arch.harness.point7.title': 'Gouvernance des outils',
    'arch.harness.point7.desc': "Gouvernance des outils et accès aux ressources (filesystem, APIs) avec politiques de sécurité intégrées.",
    'arch.harness.results.label': 'Résultats',
    'arch.harness.results.1': 'Amélioration significative du taux de réussite des tâches autonomes.',
    'arch.harness.results.2': 'Réduction des erreurs non déterministes et des comportements imprévisibles.',
    'arch.harness.results.3': "Augmentation de la capacité des agents à produire du code complexe de manière fiable et reproductible.",
